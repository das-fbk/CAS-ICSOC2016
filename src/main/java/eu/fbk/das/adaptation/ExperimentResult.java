...
public class ExperimentResult extends Loggable {
    ...
    public ExperimentResult(int id, long dv1, long dv2, double dv3, int dv4, int dv5, int dv6, int dv7) {
	this.id = id;
	this.dv1 = dv1;
	this.dv2 = dv2;
	this.dv3 = dv3;
	...
	String result = "id" + commaDelimiter + "dv1" + commaDelimiter + "dv2" + commaDelimiter + "dv3" + commaDelimiter
		+ "dv4" + commaDelimiter + "dv5" + commaDelimiter + "dv6" + commaDelimiter + "dv7";
	return result;
    }
