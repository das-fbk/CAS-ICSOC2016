...
public class EnsembleManager {
    ...
    public void checkIssues(CollectiveAdaptationProblem cap, String capID, CAWindow window,
	    ...
	    CATree hierarchyTree, HashMap<RoleManager, HashMap<String, ArrayList<Integer>>> GlobalResult, CATree cat,
	...
	if (AllChecked()) {
		...
		startEdge = an.resolveIssue(cap, capID, ir, this, window, cat, ensembles, solution, issueIndex,
			hierarchyTree, graph, startEdge);
		// print results
		// System.out.println(
		// "******* VALORI PER IL RUOLO: " +
	    ...
	    this.checkIssues(cap, capID, window, ensembles, solution, issueIndex, hierarchyTree, GlobalResult, cat,
		    graph, startEdge);
